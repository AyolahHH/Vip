...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/AyolahHH/vip/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/AyolahHH/izinvps/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/AyolahHH/izinvps/main/ip | grep $ipsaya | awk '{print $3}')
...
wget https://raw.githubusercontent.com/AyolahHH/vip/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
